...
namespace Learn.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public UserManager<LearnUser> UserManager { get; private set; }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new LearnUser() { UserName = model.UserName };
        ...
        private async Task SignInAsync(LearnUser user, bool isPersistent)
        {
